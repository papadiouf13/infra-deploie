...
| Grafana | Console + Alerting | Datasources provisionnés ; **9 dashboards v2** (NOC, hôte, Docker, Traefik + heatmap, applications, **projets + détail par projet**, logs, Trivy) ; règles de gravité |
